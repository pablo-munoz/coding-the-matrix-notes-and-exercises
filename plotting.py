"""
A replacement for the simple plotting interface, provided with the
Coding the matrix book which uses matplotlib instead of a browser and
scalable vector graphics for the ability to include plots in jupyter
notebooks.
"""
...
def plot(L, scale=4, *args, **kwargs):
    x_data = []
    y_data = []
    ...
    plt.plot(x_data, y_data, marker='o', color='red', linestyle='None', markersize=2.5)

# The commented code below was the code originally offered as the plotting
# functionality by the coding the matrix book.
